...
namespace WardrobeMVC.Controllers
{
    public class OccasionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OccasionID,Occassion")] Occasion occasion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OccasionID,Occassion")] Occasion occasion)
        {
            if (ModelState.IsValid)
            {
