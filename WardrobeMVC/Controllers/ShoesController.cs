...
namespace WardrobeMVC.Controllers
{
    public class ShoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShoeID,Name,Photo,ColorID,SeasonID,OccasionID")] Sho sho)
        {
            ...
            ViewBag.OccasionID = new SelectList(db.Occasions, "OccasionID", "Occassion", sho.OccasionID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShoeID,Name,Photo,ColorID,SeasonID,OccasionID")] Sho sho)
        {
            if (ModelState.IsValid)
            {
